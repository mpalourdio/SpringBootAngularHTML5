...
The ``base-href`` in configured by the ResourceResolver. It takes the value of the application [context-path](src/main/resources/application.properties#L11) at runtime when server by tomcat.
