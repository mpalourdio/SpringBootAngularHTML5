...
This prject includes too a custom [http interceptor](front/src/app/http-interceptor.service.ts). It's useful to show a loader during long http requests for example.
