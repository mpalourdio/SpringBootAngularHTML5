...
To test the project, run [Application](src/main/java/com/mpalourdio/html5/main), and point your browser to [http://localhost:8080/my-context](http://localhost:8080/my-context).
